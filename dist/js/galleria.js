	    ...
	    _createClass(Section, [{
	        ...
	        value: function init() {
	            ...
	            if (this.thumbnails.length > 0) {
	                window.addEventListener('resize', function (event) {
	                    _this._onWindowResize(event);
	                });
	                setTimeout(function (_) {
	                    _this._onWindowResize(null);
	                }, 100);
	            }
	        }
	    }, {
	        ...
	        value: function _onThumbnailCanExpand(thumbnail) {
	            ...
	            if (proceed) {
	                ...
	                var coords = { x: window.scrollX, y: window.scrollY },
	                    ...
	                    if (typeof _this2.onThumbnailDidExpand === 'function') {
	                        _this2.onThumbnailDidExpand(_this2, thumbnail.data, thumbnail.getNode(), _this2._previewer);
	                    }
	                }).start();
	            }
	        ...
	        value: function _onWindowResize(event) {
	            if (this._headerNode && this.thumbnails && this.thumbnails.length > 0) {
	                var pos = this._getPositionInPage(this.thumbnails[0].getNode());
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".galleria .galleria-section::after {\n  content: \"\";\n  display: table;\n  clear: both; }\n\n.galleria .galleria-section-header {\n  /*text-align: center;*/ }\n\n.galleria .galleria-thumbnails-wrapper {\n  text-align: center; }\n\n.galleria .galleria-thumbnail {\n  display: inline-block;\n  margin: 0 5px;\n  vertical-align: top;\n  width: 100px;\n  cursor: pointer;\n  transition: transform 0.3s ease; }\n  .galleria .galleria-thumbnail img {\n    display: block;\n    width: 100%;\n    height: auto; }\n  .galleria .galleria-thumbnail.expanded {\n    transform: scale(1.05); }\n\n.galleria .galleria-previewer {\n  display: block;\n  box-sizing: border-box;\n  float: left;\n  width: 100%;\n  height: 0px;\n  background: #ccc;\n  margin-top: 7px;\n  overflow: hidden;\n  transition: height 0.3s ease; }\n\n/*# sourceMappingURL=data:application/json;base64, */\n", ""]);
